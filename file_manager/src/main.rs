...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    eframe::run_native(Box::new(FileManager::default()), options)
}
...
struct FileManager {
    ...
    search_query: String,
    preview_image: Option<RetainedImage>,  // For image previews
}
...
impl FileManager {
    ...
    fn load_image(&self, file_path: &PathBuf) -> Option<RetainedImage> {
    ...
    fn search_in_directory(&mut self, directory: &PathBuf) {
